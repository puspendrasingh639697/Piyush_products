...
// import { FaRupeeSign, FaHeart, FaRegHeart, FaStar, FaStarHalfAlt, FaRegStar, FaPlus, FaMinus, FaShoppingCart } from 'react-icons/fa';
...
//                                         className="w-full py-3 bg-gray-900 text-white rounded-lg hover:bg-gray-800 transition-colors flex items-center justify-center gap-2 disabled:opacity-50"
//                                     >
//                                         <FaShoppingCart />
